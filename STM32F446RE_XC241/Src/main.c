...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  /*Realiza o controle do speaker. Mantém o speaker 500 ms ligado.
   * Seta o valor de ARR manualmente, o valor de CCR1 não precisa ser zerado,
   * pois isto é feito aumaticamente.
   * oBS: 54000000 = 1 segundo*/
